...
export const Documentation: React.FC = () => {
  ...
  const terms = [
    ...
    },
    {
      ...
      detail:
        '包含指派負責人員、優先等級 (CRITICAL, HIGH, MEDIUM, LOW)、SLA 處理期限、執行摘要、根因分析、修補步驟、臨時緩和措施與資安掃描複測指令。',
    },
    {
      ...
      detail:
        '系統自動分析最新升級版號（如 nginx 1.22.0 ➜ 1.26.1）能消除多少個已有 CVE 漏洞，並支援指派產品修補工單與追蹤處置進度。',
    },
    {
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="搜尋專業資安名詞 (如: CVE, CPE, CVSS, CISA KEV, EPSS, Ticket, SLA...)"
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-2xs space-y-5">
            <div className="border-b border-slate-100 pb-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  本系統透過自動化排程與手動掃描流程，即時同步全球最權威的國際資安資料庫。
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/70 hover:border-purple-300 transition-all space-y-2">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  基於歷史資料與機器學習模型評估未來 30 天內漏洞被「武器化攻擊利用」之機率百分比 (0-100%)，協助資安團隊預防性修補。
                </p>
            ...
            <div className="border-b border-slate-100 pb-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    說明 SentinelCVE 平台最新頁面架構下，如何精準進行產品/CPE 對照維護、點擊 CVE 彈窗查看詳細資訊與派發修補工單。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-gradient-to-br from-indigo-900 via-slate-900 to-blue-950 text-white space-y-4 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                ...
                <div className="bg-white/10 backdrop-blur-md p-3.5 rounded-xl border border-white/10 space-y-1.5">
                  ...
                  <p className="text-[11px] text-slate-300 leading-snug">
                    依專案 CVSS/KEV 條件觸發 Teams Webhook 通知，並可建立包含 Workaround 與複測步驟的修補工單。
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-slate-900">維護「產品管理」中的 CPE 對照與資產關聯</h4>
                      <p className="text-xs text-slate-500">適合情境：建立產品名稱與標準 CPE 對照，供專案資產與弱點比對流程使用。</p>
                    </div>
                  </div>
                ...
                <div className="text-xs text-slate-700 space-y-2 leading-relaxed">
                  <ol className="list-decimal list-inside pl-2 space-y-1.5">
                    <li>進入<strong>「系統管理」</strong>主頁面，切換至<strong>「產品管理」</strong>子頁籤。</li>
                    <li>
                      於頁面上方輸入產品名稱查詢 NVD CPE Dictionary，或手動維護標準 CPE 語法（例如 <code className="bg-white px-1.5 py-0.5 rounded border border-slate-200 font-mono text-slate-800">cpe:2.3:a:nginx:nginx:*:*:*:*:*:*:*:*</code>）。
                    </li>
                    <li>將查得的 vendor:product 候選結果儲存為快取，供專案中綁定產品與版本時重複使用。</li>
                    <li>
                      <strong>平台運作邏輯：</strong>系統排程（或手動掃描）會依現有產品清單與專案套用版本查詢官方版本來源、NVD 及 OSV 等弱點資料；符合專案條件的弱點才會透過 Teams Webhook 通知。
                    </li>
                  </ol>
                </div>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-slate-900">點擊任意 CVE 編號開啟「CVE 漏洞詳細資訊 Modal」</h4>
                ...
                <div className="text-xs text-slate-700 space-y-2 leading-relaxed">
                  <ol className="list-decimal list-inside pl-2 space-y-1.5">
                    ...
                    <li>
                       Modal 中直觀呈現場景描述、CVSS 評分細節、CISA KEV 攻擊狀態與 NVD 官方連結，供資安人員快速檢閱與複核。
                    </li>
                  </ol>
                </div>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-slate-900">使用產品管理頁面查詢 / 手動維護 CPE 對照</h4>
                      <p className="text-xs text-slate-500">適合情境：需要補齊新產品的標準 CPE vendor:product 對照，供後續比對使用。</p>
                    </div>
                  </div>
                ...
                <div className="text-xs text-slate-700 space-y-2 leading-relaxed">
                  <ol className="list-decimal list-inside pl-2 space-y-1.5">
                    <li>在「系統管理 &gt; 產品管理」中輸入產品名稱，點擊「查詢並更新」向 NVD 取得候選結果。</li>
                    <li>若 NVD 查無結果，可點擊「手動新增」直接維護產品名稱與 CPE 清單。</li>
                    <li>
                      <strong>平台運作邏輯：</strong>平台會將儲存的 CPE 對照快取提供給專案套用與弱點比對流程，避免重複查詢相同產品。
                    </li>
                  </ol>
                </div>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-slate-900">專案產品版本升級對照表與修補工單派發</h4>
                      <p className="text-xs text-slate-500">適合情境：專案經理與 DevSecOps 團隊快速評估整體專案升級版本並建立修補工單。</p>
                    </div>
                  </div>
                ...
                <div className="text-xs text-slate-700 space-y-2 leading-relaxed">
                  <ol className="list-decimal list-inside pl-2 space-y-1.5">
                    ...
                    <li>
                      也可直接於「資安處置工單」頁籤建立或指派工單，追蹤專案內各項漏洞修補進度。
                    </li>
                  </ol>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
              ...
              <ul className="text-xs text-slate-700 space-y-1.5 list-disc list-inside pl-2 leading-relaxed">
                ...
                <li><strong>工單指派與追蹤：</strong>可由產品版本對照或弱點列表快速建立工單，並在工單看板追蹤處置進度。</li>
              </ul>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-sm font-bold text-slate-900">系統管理 (System Manager - 3 大核心子頁籤)</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
                <div className="bg-white p-3 rounded-xl border border-slate-200 space-y-1">
                  ...
                  <p className="text-[11px] text-slate-600">設定定時掃描週期（每幾小時/每日）與 Teams / Email 通報開關。</p>
                </div>
                ...
                <div className="bg-white p-3 rounded-xl border border-slate-200 space-y-1">
                  ...
                  <p className="text-[11px] text-slate-600">維護產品名稱與 CPE 對照快取，供專案資產關聯與弱點比對使用。</p>
                </div>
      ...
      {activeTab === 'workflow' && (
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-2xs space-y-6">
          <div className="border-b border-slate-100 pb-4">
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              系統如何實現從「資產清單」&rarr;「官方版本與弱點檢索」&rarr;「風險篩選」&rarr;「Teams 通知與工單追蹤」的處置閉環。
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 relative">
            <div className="p-4 rounded-2xl bg-blue-50 border border-blue-200 space-y-2">
              ...
              <p className="text-[11px] text-slate-600 leading-snug">
                系統排程器 (Scheduler) 定時讀取既有產品清單與專案套用版本資料，執行弱點比對。
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-purple-50 border border-purple-200 space-y-2">
              ...
              <h3 className="text-xs font-bold text-slate-900">3. 建立處置工單</h3>
              <p className="text-[11px] text-slate-600 leading-snug">
                系統依專案 CVSS 門檻與 CISA KEV 條件篩選；使用者可建立處置計畫、Workaround 與複測建議，再由人員確認派單。
              </p>
            </div>
          ...
          <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 text-xs text-slate-700 space-y-2">
            ...
            <p>
              「系統管理」負責掃描排程、產品管理與稽核日誌；Teams Webhook、CVSS/KEV 條件及版本/CVE 通知頻率均由各專案獨立管理。
            </p>
          </div>
        </div>
      )}
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1.5">
              ...
              <p className="text-xs text-slate-600 leading-relaxed pl-5">
                系統為 4 大主要頁面：<strong>「總覽儀表板」</strong>、<strong>「專案管理」</strong>、<strong>「系統管理」</strong>（排程/產品管理/日誌）與<strong>「系統說明與專業名詞」</strong>。專案 Webhook 與通知條件請在「專案管理」設定。
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1.5">
              <h3 className="text-xs font-bold text-slate-900 flex items-center space-x-1.5">
                ...
                <span>要如何檢索個別 CVE 漏洞詳細資料？</span>
              </h3>
              <p className="text-xs text-slate-600 leading-relaxed pl-5">
                在「總覽儀表板」或「專案管理」中，點擊任何一個 CVE ID（例如 <code className="bg-white px-1 border border-slate-200 font-mono text-blue-600">CVE-2024-3094</code>），系統會隨即拉出「CVE 漏洞詳細資訊 Drawer / Modal」，顯示完整的 CVSS 評分、CISA KEV 狀態與 NVD 參照連結。
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1.5">
              ...
              <p className="text-xs text-slate-600 leading-relaxed pl-5">
                進入「系統管理」主頁面，切換至「📦 產品管理」頁籤，輸入產品名稱後點擊「查詢並更新」即可從 NVD 取得候選 CPE；如有需要也可使用「手動新增」自行維護。
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1.5">
              ...
              <p className="text-xs text-slate-600 leading-relaxed pl-5">
                您可以在「專案管理」中，選擇專案並切換至「產品版本與升級對照」或「資安處置工單」，點擊個別產品旁的「指派升級修補工單」，或於工單頁籤中手動建立綜合性修補工單。
              </p>
            </div>
